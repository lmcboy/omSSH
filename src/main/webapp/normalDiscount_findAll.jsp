...
<link href="files/zhekouchaxun/styles.css" type="text/css" rel="stylesheet" />
...
<script src="files/zhekouchaxun/data.js"></script>
	...
	<div id="base" class="">
		...
		<div id="u241" class="ax_vertical_line">
			<img id="u241_start" class="img "
				...
				src="images/login/u105_line.png" alt="u241_line" />
		</div>
        
		<!-- Unnamed (HTML Button) -->
		<div id="u242" class="ax_html_button">
			<input id="u242_input" type="submit" value="查询" onclick="getOne()" />
		</div>
		...
		<div id="u245" class="ax_text_field">
			<input id="u245_input" type="text" name="discount_name"/>
		</div>
		...
		<div id="u248" class="ax_text_field">
			<input id="u248_input" type="text" name="type" value="" />
		</div>

		<!-- Unnamed (HTML Button) -->
		<div id="u249" class="ax_html_button">
			<a href="normalDiscount_save.jsp"><input id="u249_input" type="button" value="新增" /></a>
		</div>

...
<link href="files/zhekouxinzheng/styles.css" type="text/css" rel="stylesheet" />
...
<script src="files/zhekouxinzheng/data.js"></script>
	...
	<div id="base" class="">
							...
							<div id="u70_children" class="u70_children">
								...
								<div id="u75" class="ax_tree_node treenode">
									...
									<div id="u76" class="" selectiongroup="u5_tree_group">
										<img id="u76_img" class="img " src="images/jiagebiao/u65.png" />
										<!-- Unnamed () -->
		...
		<form action="discount-save" method="post">
			<table class="table table-striped table-bordered table-hover ">
				...
				<tbody>
				<s:iterator value="#session.list" status="status">
					<tr>
						<td><input type="hidden" name="discount_id" value="<s:property value="discountId"/>"></td>
						...
						<td>
						    <select name="discount_base">
						       <option><s:property value="discountBase"/></option>
						       <option>数量</option>
						       <option>单价</option>
						    </select>					
						</td>
							<td><input type="text" name="base_qty"value="<s:property value="baseQty"/>"></td>						
						
						<td><input type="text" name="discount_rate"value="<s:property value="discountRate"/>"></td>
		...
		<div id="u173" class="ax_vertical_line">
			<img id="u173_start" class="img "
				...
				src="images/login/u105_line.png" alt="u173_line" />
		</div>
		...
		<div id="u179" class="ax_horizontal_line">
			<img id="u179_start" class="img "
				...
				src="images/dingdandaoru/u136_line.png" alt="u179_line" />
		</div>
	</div>
</body>
</html>
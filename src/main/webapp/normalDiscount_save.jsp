		...
		<form action="discount-add" method="post">
			<table class="table table-striped table-bordered table-hover ">
				...
				<tbody>
					...
					<tr>
						<td><input type="hidden" name="discount_id" ></td>
						<td><input type="text" name="discount_name"></td>	
						<td>
						    <select name="type" id="s">
						       <option>一般折扣</option>
						       <option>通用加价</option>
						    </select>					
						</td>										
						<td>
						    <select name="discount_base" id="s1">
						       <option>金额</option>
						       <option>数量</option>
						       <option>单价</option>
						    </select>					
						</td>
							<td><input id="q" type="text" name="base_qty" disabled="disabled"></td>						

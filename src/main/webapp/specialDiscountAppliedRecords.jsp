...
<body>
	<div id="base" class="">
					...
					<div id="u9_children" class="u9_children"
						...
						<div id="u14" class="ax_tree_node treenode">
							...
							<div id="u15" class="" selectiongroup="u5_tree_group">
								<img id="u15_img" class="img " src="images/discount/u15.png" />
								<!-- Unnamed () -->
		...
		<div id="u142" class="ax_table,table-responsive">
           ...
           <s:iterator value="#session.ls">
			 折扣金额: <s:property value="amount"/> 已用金额: <s:property value="appliedAmount"/> 折扣余额: <s:property value="balance"/>
           </s:iterator>
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
					<s:iterator value="#session.list">
						<tr>
							<td><s:property value="sdarId" /></td>
							<td><s:property value="discountName" /></td>
							<td><s:property value="custCode" /></td>
							<td><s:property value="adnIdentifyNum" /></td>
							<td><s:property value="appliedAmount" /></td>
							<td><s:property value="appliedDate" /></td>
							<td><s:property value="cancel" /></td>
							<td><s:property value="cancelDate" /></td>
						</tr>
					</s:iterator>
				</tbody>

...
<html>
  <head>
    ...
    <link href="files/价格表查询/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/价格表查询/data.js"></script>
  ...
  %>
    <div id="base" class="">
      ...
      <div id="u320" class="ax_vertical_line">
        ...
        <img id="u320_line" class="img " src="images/登录/u105_line.png" alt="u320_line"/>
      </div>

      <!-- Unnamed (HTML Button) -->
      <div id="u321" class="ax_html_button">
        <input id="u321_input" type="submit" value="导入EXCEL"/>
      </div>
      ...
      <div id="u324" class="ax_horizontal_line">
        ...
        <img id="u324_line" class="img " src="images/订单导入/u136_line.png" alt="u324_line"/>
      </div>

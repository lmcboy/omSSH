	...
	<div id="base" class="">
			...
			<div id="u5_children" class="u5_children">
					...
					<div id="u9_children" class="u9_children"
						...
						<div id="u14" class="ax_tree_node treenode">
							...
							<div id="u15" class="" selectiongroup="u5_tree_group">
								<img id="u15_img" class="img " src="images/zhekouchaxun/u15.png" />
								<!-- Unnamed () -->
				...
				<div id="u26" class="ax_tree_node treenode">
					...
					<div id="u27" class="ax_image">
						<img id="u27_img" class="img " src="images/login/u10.png" />
						<!-- Unnamed () -->
				...
				<div id="u37" class="ax_tree_node treenode">
					...
					<div id="u38" class="ax_image">
						<img id="u38_img" class="img " src="images/login/u10.png" />
						<!-- Unnamed () -->
				...
				<div id="u45" class="ax_tree_node treenode">
					...
					<div id="u46" class="ax_image">
						<img id="u46_img" class="img " src="images/login/u10.png" />
						<!-- Unnamed () -->
					...
					<div id="u45_children" class="u45_children"
						...
						<div id="u50" class="ax_tree_node treenode">
							...
							<div id="u51" class="" selectiongroup="u5_tree_group">
								<img id="u51_img" class="img " src="images/shougong/u56.png" />
								<!-- Unnamed () -->
				...
				<div id="u59" class="ax_tree_node treenode">
					...
					<div id="u60" class="ax_image">
						<img id="u60_img" class="img " src="images/login/u10_selected.png" />
						<!-- Unnamed () -->
							...
							<div id="u70_children" class="u70_children">
								...
								<div id="u75" class="ax_tree_node treenode">
									...
									<div id="u76" class="" selectiongroup="u5_tree_group">
										<img id="u76_img" class="img " src="images/onecheck/u76.png" />
										<!-- Unnamed () -->
										<div id="u77" class="text" onclick="location='normalDiscount_findAll.jsp'">
											<p>
												<span>经常性折扣</span>
											</p>
										</div>
								...
								<div id="u78" class="ax_tree_node treenode">
									...
									<div id="u79" class="" selectiongroup="u5_tree_group">
										<img id="u79_img" class="img " src="images/jiagebiao/u65.png" />
										<!-- Unnamed () -->
										<div id="u80" class="text" onclick="location='specialDiscount.jsp'">
											<p>
												<span>一次性折扣</span>
											</p>
										</div>
				...
				<div id="u120" class="ax_tree_node treenode">
					...
					<div id="u121" class="ax_image">
						<img id="u121_img" class="img " src="images/login/u10.png" />
						<!-- Unnamed () -->
		...
		<div id="u141" class="ax_horizontal_line">
			<img id="u141_start" class="img "
				...
				src="images/login/u104_line.png" alt="u141_line" />
		</div>

		<!-- Unnamed (Table) -->
		<div id="u142" class="ax_table,table-responsive">
			<form action="special-save" method="post">
				<table class="table table-striped table-bordered table-hover ">
					...
					<tr>
					 <td><input type="hidden" name="sd_id" value="<s:property value="sdId"/>"></td>
					  <td><input type="text" name="discount_name" value="<s:property value="discountName"/>"></td>
					  <td><input type="text" name="cust_code" value="<s:property value="custCode"/>" readonly="readonly"></td>
					  <td><input type="text" name="amount" value="<s:property value="amount"/>"></td>
					  <td><input type="text" name="applied_amount" value="<s:property value="appliedAmount"/>" readonly="readonly" ></td>
					  <td><input type="text" name="balance" value="<s:property value="balance"/>" readonly="readonly"></td>
					  <td><input type="text" name="activity" value="<s:property value="activity"/>"></td>					  
					</tr>
					<input type="hidden" id="cust_id" name="cust_id" value="<s:property value="omCustomersInfo.getCustId()"/>">
					</s:iterator>
					</tbody>					
				</table>
				<button type="submit" class="btn btn-info btn-xs">提交</button>
			</form>
		...
		<div id="u169" class="ax_vertical_line">
			<img id="u169_start" class="img "
				src="resources/images/transparent.gif" alt="u169_start" /> <img
				id="u169_end" class="img " src="resources/images/transparent.gif"
				alt="u169_end" /> <img id="u169_line" class="img "
				src="images/login/u105_line.png" alt="u169_line" />
		</div>
		...
		<div id="u173" class="ax_horizontal_line">
			<img id="u173_start" class="img "
				...
				src="images/dingdandaoru/u136_line.png" alt="u173_line" />
		</div>

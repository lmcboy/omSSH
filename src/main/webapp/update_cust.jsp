  ...
  <body onload="select();">
    ...
    <form id="addressForm" >
      ...
      <div id="u163" class="ax_text_field" data-label="Zip / postcode">
        <input id="u163_input" type="text" value="有效" readonly="readonly"/>
      </div>
      <!-- Zip / postcode (失效日期) -->
    ...
    <form id="payForm">
      ...
      <div id="u204" class="ax_text_field" data-label="Zip / postcode">
      	<input id="u204_input" type="text" name="discountId" readonly="readonly" value="${customer.omCustDiscount.discountId }"/>
      </div>
      <!-- Zip / postcode (结算货币) -->

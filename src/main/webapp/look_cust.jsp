...
<html>
  <head>
    ...
    <link href="files/客户管理/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/客户管理/data.js"></script>
  ...
  <body>
    ...
    <form>
      ...
      <div id="u111" class="ax_text_field">
        <input id="u111_input" type="text" name="custName" value="customerName"/>
      </div>
      <!-- Unnamed (类型) -->
      <div id="u119" class="ax_text_field">
        <input id="u119_input" type="text" readonly="readonly" value="STD"/>
      </div>
      <!-- Unnamed (客户简称) -->
      <div id="u123" class="ax_text_field">
        <input id="u123_input" type="text" value="customerCode"/>
      </div>
      <!-- Unnamed (状态) -->
      <div id="u127" class="ax_text_field">
        <input id="u127_input" type="text" value="全部"/>
      </div>
      <!-- Unnamed (集团公司) -->
      <div id="u222" class="ax_text_field">
        <input id="u222_input" type="text" value="GTW-G"/>
      </div>
      <!-- Unnamed (总公司) -->
      <div id="u225" class="ax_text_field">
        <input id="u225_input" type="text" value="GTW-NY"/>
      </div>
      <!-- Unnamed (HTML Button) -->
      ...
      <div id="u157" class="ax_html_button">
        <input id="u157_input" type="submit" value="保存"/>
      </div>
    ...
    <form>
      ...
      <div id="u134" class="ax_text_field" data-label="City / town">
        <input id="u134_input" type="text" value="Los Angeles"/>
      </div>
      <!-- State / county (州/省) -->
      <div id="u135" class="ax_text_field" data-label="State / county">
        <input id="u135_input" type="text" value="California"/>
      </div>
      <!-- Country (国家) -->
      ...
      <div id="u131" class="ax_text_field" data-label="Zip / postcode">
        <input id="u131_input" type="text" value="20930"/>
      </div>
      <!-- Zip / postcode (目的港) -->
      <div id="u151" class="ax_text_field" data-label="Zip / postcode">
        <input id="u151_input" type="text" value="Los Angeles"/>
      </div>
      <!-- Zip / postcode (唛头) -->
      <div id="u228" class="ax_text_field" data-label="Zip / postcode">
        <input id="u228_input" type="text" value="ABC,SHIPPING MARK,FORD AUTO"/>
      </div>
      <!-- Zip / postcode (有效) -->
      <div id="u163" class="ax_text_field" data-label="Zip / postcode">
        <input id="u163_input" type="text" value="有效"/>
      </div>
      <!-- Zip / postcode (失效日期) -->
      <div id="u154" class="ax_text_field" data-label="Zip / postcode">
        <input id="u154_input" type="text" value="yyyy-mm-dd"/>
      </div>
      <!-- Unnamed (地址信息保存) -->
      <div id="u129" class="ax_html_button">
        <input id="u129_input" type="submit" value="保存"/>
      </div> 
    </form>
    <!-- 付款信息Form -->
    <form>
    ...
    <form>
      ...
      <div id="u115" class="ax_paragraph">
        ...
        <!-- Unnamed () -->
        <div id="u116" class="text" name="customer_name">
          <p><span>客户名称</span></p>
        </div>
      </div>
      ...
      <div id="u121" class="ax_paragraph">
        ...
        <div id="u122" class="text">
          <p><span>地址行</span><span>1</span></p>
        </div>
      </div>

      <!-- Unnamed (Vertical Line) -->
      <div id="u124" class="ax_vertical_line">
        <img id="u124_start" class="img " src="resources/images/transparent.gif" alt="u124_start"/>
        <img id="u124_end" class="img " src="resources/images/transparent.gif" alt="u124_end"/>
        <img id="u124_line" class="img " src="images/登录/u105_line.png" alt="u124_line"/>
      </div>
      ...
      <div id="u128" class="ax_html_button">
        <input id="u128_input" type="button" href="new_cust.jsp" value="新建"/>
      </div>
      ...
      <div id="u130" class="ax_horizontal_line">
        ...
        <img id="u130_end" class="img " src="resources/images/transparent.gif" alt="u130_end"/>
        <img id="u130_line" class="img " src="images/订单导入/u136_line.png" alt="u130_line"/>
      </div>

      <!-- Address line 1 (Text Field) [footnote] -->
      <div id="u132_ann" class="annotation"></div>
      <!-- Address line 2 (Text Field) [footnote] -->
      <div id="u133_ann" class="annotation"></div>

      <!-- City / town (Text Field) [footnote] -->
      <div id="u134_ann" class="annotation"></div>

      <!-- State / county (Text Field) [footnote] -->
      <div id="u135_ann" class="annotation"></div>

      

      <!-- Country (Droplist) [footnote] -->
      <div id="u136_ann" class="annotation"></div>
      ...
      <div id="u137" class="ax_paragraph">
        ...
        <div id="u138" class="text">
          <p><span style="text-decoration:underline;">地址信息</span></p>
        </div>
      </div>
      ...
      <!-- Unnamed (Horizontal Line) -->
      <div id="u158" class="ax_horizontal_line">
        <img id="u158_start" class="img " src="resources/images/transparent.gif" alt="u158_start"/>
        <img id="u158_end" class="img " src="resources/images/transparent.gif" alt="u158_end"/>
        <img id="u158_line" class="img " src="images/订单导入/u136_line.png" alt="u158_line"/>
      </div>
      ...
      <div id="u159" class="ax_paragraph">
        ...
        <div id="u160" class="text">
          <p><span style="text-decoration:underline;">付款</span><span style="text-decoration:underline;">信息</span></p>
        </div>
      </div>
      ...
      <!-- Zip / postcode (Text Field) [footnote] -->
      <div id="u163_ann" class="annotation"></div>
      ...
      <!-- Zip / postcode (Text Field) [footnote] -->
      <div id="u166_ann" class="annotation"></div>
      ...
      <!-- Zip / postcode (Text Field) [footnote] -->
      <div id="u169_ann" class="annotation"></div>
      ...
      <!-- Zip / postcode (Text Field) [footnote] -->
      <div id="u172_ann" class="annotation"></div>

      <!-- Unnamed (Shape) -->
      <div id="u173" class="ax_paragraph">
        <img id="u173_img" class="img " src="resources/images/transparent.gif"/>
        <!-- Unnamed () -->
        <div id="u174" class="text">
          <p><span>价格</span><span>条款1</span></p>
        </div>
      </div>
      ...
      <!-- Zip / postcode (Text Field) [footnote] -->
      <div id="u175_ann" class="annotation"></div>
      ...
      <div id="u177" class="ax_paragraph">
        ...
        <div id="u178" class="text">
          <p><span>价格</span><span>条款</span><span>2</span></p>
        </div>
      </div>
      ...
      <div id="u180" class="ax_paragraph">
        ...
        <div id="u181" class="text">
          <p><span>价格</span><span>条款</span><span>3</span></p>
        </div>
      </div>

      <!-- Unnamed (Horizontal Line) -->
      <div id="u182" class="ax_horizontal_line">
        <img id="u182_start" class="img " src="resources/images/transparent.gif" alt="u182_start"/>
        <img id="u182_end" class="img " src="resources/images/transparent.gif" alt="u182_end"/>
        <img id="u182_line" class="img " src="images/订单导入/u136_line.png" alt="u182_line"/>
      </div>
      ...
      <div id="u184" class="ax_paragraph">
        ...
        <div id="u185" class="text">
          <p><span style="text-decoration:underline;">组织</span><span style="text-decoration:underline;">信息</span></p>
        </div>
      </div>
      ...
      <div id="u186" class="ax_paragraph">
        ...
        <div id="u187" class="text">
          <p><span>* </span><span>业务经理</span></p>
        </div>
      </div>

      <!-- Zip / postcode (Text Field) -->
      <div id="u188" class="ax_text_field" data-label="Zip / postcode">
        <input id="u188_input" type="text" value="张某某"/>
      </div>

      <!-- Zip / postcode (Text Field) [footnote] -->
      <div id="u188_ann" class="annotation"></div>
      ...
      <div id="u189" class="ax_paragraph">
        ...
        <div id="u190" class="text">
          <p><span>* </span><span>所属</span><span>TEAM</span></p>
        </div>
      </div>

      <!-- Zip / postcode (Text Field) -->
      <div id="u191" class="ax_text_field" data-label="Zip / postcode">
        <input id="u191_input" type="text" value="05-美国"/>
      </div>

      <!-- Zip / postcode (Text Field) [footnote] -->
      <div id="u191_ann" class="annotation"></div>
      ...
      <div id="u192" class="ax_paragraph">
        ...
        <div id="u193" class="text">
          <p><span>* </span><span>业务</span><span>助理</span></p>
        </div>
      </div>

      <!-- Zip / postcode (Text Field) -->
      <div id="u194" class="ax_text_field" data-label="Zip / postcode">
        <input id="u194_input" type="text" value="李某某"/>
      </div>

      <!-- Zip / postcode (Text Field) [footnote] -->
      <div id="u194_ann" class="annotation"></div>

      <!-- Unnamed (Horizontal Line) -->
      <div id="u195" class="ax_horizontal_line">
        ...
        <img id="u195_line" class="img " src="images/订单导入/u136_line.png" alt="u195_line"/>
      </div>

      <!-- Unnamed (HTML Button) -->
      <div id="u196" class="ax_html_button">
        <input id="u196_input" type="submit" value="保存"/>
      </div>
      ...
      <div id="u197" class="ax_paragraph">
        ...
        <div id="u198" class="text">
          <p><span style="text-decoration:underline;">联系人</span><span style="text-decoration:underline;">信息</span></p>
        </div>
      </div>
      ...
      <!-- Zip / postcode (Text Field) [footnote] -->
      <div id="u201_ann" class="annotation"></div>
      ...
      <!-- Unnamed (Shape) -->
      <div id="u205" class="ax_paragraph">
      ...
      <!-- Unnamed (Shape) -->
      <div id="u217" class="ax_paragraph">
      ...
      <!-- Unnamed (Shape) -->
      <div id="u220" class="ax_paragraph">

...
<head>
  ...
  <body>
	...
	<!-- 查询Form -->
	<form action="custInfo-getAll" method="post">
		<!-- Unnamed (客户名称) -->
      ...
      <div id="u119" class="ax_text_field">
        <input id="u119_input" type="text" value="STD" readonly="readonly"/>
      </div>
      <!-- Unnamed (集团公司) -->
      <div id="u132" class="ax_text_field">
        <input id="u132_input" type="text" value="GTW-G" readonly="readonly"/>
      </div>
      <!-- Unnamed (客户简称) -->
      <div id="u121" class="ax_text_field">
        <input id="u121_input" type="text" name="customerCode"/>
      </div>
      <!-- Unnamed (状态) -->
      <div id="u125" class="ax_text_field">
        <input id="u125_input" type="text" name="custInfo.status"/>
      </div>
      <!-- Unnamed (总公司) -->
      <div id="u135" class="ax_text_field">
        <input id="u135_input" type="text" value="GTW-NY" readonly="readonly"/>
      </div>
      <!-- Unnamed (客户信息查询) -->
      ...
      <table id="custable" cellspacing="0" cellpadding="1">
      	<tr>
      		<th>序号</th>

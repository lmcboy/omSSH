...
<body>
	<div id="base" class="">
		...
		<div id="u142" class="ax_table,table-responsive">
			<form action="special-insert" method="post">
				<table class="table table-striped table-bordered table-hover ">
					...
					<tr>					 
					  ...
					  <td><input type="text" id="cust_code" name="cust_code" onclick="getcode()"></td>
					  <td><input type="text" id="amount" name="amount"></td>
					  <td><input type="text" id="applied_amount" name="applied_amount" readonly="readonly" ></td>
					  <td><input type="text" id="balance" name="balance"  readonly="readonly"></td>
					  <td><input type="text" name="activity" value="是"/></td>					  
					</tr>					
					</tbody>										
				</table>
	...
	<script type="text/javascript">
	    function getcode(){
	    	...
	    	var applied_amount = $("#applied_amount");
	    	var balance = $("#balance");
	    	var cust_id = $("#cust_id");
	    	$.ajax({
	    		url:'/omSSH/special-findAmount',
	    		dataType:'json',
	    		data:'cust_code='+cust_code,
	    		success:function(data){
	    			applied_amount.attr("value",data.applied_amount);
	    			balance.attr("value",data.balance);
	    			cust_id.attr("value",data.cust_id);
	    		}
	    	});
	    }

  ...
  <body>
    ...
    <form action="custInfo-addCust" method="post">
      ...
      <div id="u123" class="ax_text_field">
        <input id="u123_input" type="text" name="customerCode"/>
      </div>
      <!-- Unnamed (类型) -->
      <div id="u127" class="ax_text_field">
        <input id="u127_input" type="text" value="全部" readonly="readonly"/>
      </div>
      <!-- Unnamed (集团公司) -->
      <div id="u222" class="ax_text_field">
        <input id="u222_input" type="text" value="GTW-G" readonly="readonly"/>
      </div>
      <!-- Unnamed (总公司) -->
      ...
      <div id="u133" class="ax_text_field" data-label="Address line 2">
        <input id="u133_input" type="text" name="addressLine2"/>
      </div>
      <!-- City / town (城市) -->
      <div id="u134" class="ax_text_field" data-label="City / town">
        <input id="u134_input" type="text" value="Los Angeles" readonly="readonly"/>
      </div>
      <!-- State / county (州/省) -->
      <div id="u135" class="ax_text_field" data-label="State / county">
        <input id="u135_input" type="text" value="California" readonly="readonly"/>
      </div>
      <!-- Country (国家) -->
      ...
      <div id="u151" class="ax_text_field" data-label="Zip / postcode">
        <input id="u151_input" type="text" name="portOfDestination"/>
      </div>
      <!-- Zip / postcode (唛头) -->
      <div id="u228" class="ax_text_field" data-label="Zip / postcode">
        <input id="u228_input" type="text" name="shippingMark"/>
      </div>
      <!-- Zip / postcode (有效) -->
      ...
      <div id="u169" class="ax_text_field" data-label="Zip / postcode">
        <input id="u169_input" type="text" name="invoiceGroup"/>
      </div>
      <!-- Zip / postcode (通用加价条款) -->
      <div id="u204" class="ax_text_field" data-label="Zip / postcode">
      	<input id="u204_input" type="text" name="discountId" readonly="readonly"/>
      </div>
      <!-- Zip / postcode (结算货币) -->
      ...
      <div id="u201" class="ax_text_field" data-label="Zip / postcode">
        <select id="discount_name" name="markupName">
          <option value="无折扣">无折扣</option>
          <option value="3%折扣">3%折扣</option>
          <option value="低于50片加价5%" selected="selected">低于50片加价5%</option>
          <option value="5%折扣">5%折扣</option>
        </select>
      </div>
      <!-- Zip / postcode (付款条件) -->
      <div id="u172" class="ax_text_field" data-label="Zip / postcode">
        <select id="u172_input" name="paymentTerm">
          <option value="立即付款" elected="selected">立即付款</option>
      ...
      <div id="u175" class="ax_text_field" data-label="Zip / postcode">
        <input id="u175_input" type="text" name="priceTerm1"/>
      </div>
      <!-- Zip / postcode (价格条款2) -->
      <div id="u176" class="ax_text_field" data-label="Zip / postcode">
        <input id="u176_input" type="text" name="priceTerm2"/>
      </div>
      <!-- Zip / postcode (价格条款3) -->

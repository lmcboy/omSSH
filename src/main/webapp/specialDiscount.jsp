...
<link href="files/onecheck/styles.css" type="text/css" rel="stylesheet" />
...
<script src="files/onecheck/data.js"></script>
	...
	<div id="base" class="">
		...
		<div id="u253" class="ax_vertical_line">
			<img id="u253_start" class="img "
				...
				src="images/login/u105_line.png" alt="u253_line" />
		</div>

		<!-- Unnamed (HTML Button) -->
		<div id="u254" class="ax_html_button">
			<input id="u254_input" type="submit" value="查询" onclick="getJson()" />
		</div>

		<!-- Unnamed (Shape) -->
		<div id="u255" class="ax_paragraph">
			<img id="u255_img" class="img "
				src="resources/images/transparent.gif" />
			<!-- Unnamed () -->
		...
		<div id="u257" class="ax_text_field">
			<input id="u257_input" type="text" name="discount_name"/>
		</div>

		<!-- Unnamed (HTML Button) -->
		<div id="u258" class="ax_html_button">
			<a href="specialDiscount_save.jsp"><input id="u258_input" type="submit" value="新增" /></a>
		</div>
		...
		<div id="u262" class="ax_text_field">
			<input id="u262_input" type="text" name="cust_code"/>
		</div>
